...
function makeWriteRemTextCommand(name: 'set-text' | 'text') {
  return Command.make(
    name,
    {
...
export const writeRemSetTextCommand = makeWriteRemTextCommand('set-text');
export const writeRemTextCommand = makeWriteRemTextCommand('text');
