...
import { invokeWave1Capability } from './modeParityRuntime.js';
...
export function resolveRefValue(
  raw: string,
): Effect.Effect<string, CliError, any> {
  return Effect.gen(function* () {
    ...
    return (yield* invokeWave1Capability('resolve.ref', { ref: raw })) as string;
  });
}
